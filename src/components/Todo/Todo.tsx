...
// types
interface TodoProps {
  data: { id: string; completed: boolean; title: string };
      ...
      >
        ...
        >
          <span
            ...
            aria-hidden="true"
          ></span>
          <img src="/check.svg" aria-hidden="true" alt="" />
        </label>
        <p className="flex h-full text-black  items-center justify-start py-4 text-[16px] transition-[color] duration-500 peer-checked:text-lightGrayishBlue peer-checked:line-through dark:peer-checked:text-darkGrayishBlueD sm:text-[18px]">
          {data.title}
        </p>
        <button
          className={
